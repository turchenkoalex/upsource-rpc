...
dependencies {
    implementation("com.ecwid.upsource-rpc:client:0.9.17")

    // use one of:
    implementation("com.ecwid.upsource-rpc:gson-serializer:0.9.17")
    implementation("com.ecwid.upsource-rpc:jackson-serializer:0.9.17")

    // use one of:
    implementation("com.ecwid.upsource-rpc:httpclient:0.9.17")
    implementation("com.ecwid.upsource-rpc:apache-httpclient:0.9.17")
}
```
...
dependencies {
    implementation("com.ecwid.upsource-rpc:webhooks:0.9.17")
}
```
